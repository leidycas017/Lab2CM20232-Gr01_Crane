...
import androidx.compose.samples.crane.domain.GetDestinationUseCase
...
class MainViewModel @Inject constructor(
    ...
    private val _destination = MutableStateFlow(emptyList<DestinationItem>())
    val destination: StateFlow<List<DestinationItem>> get() = _destination
    ...
    private fun getDestination(){
        viewModelScope.launch{
            try {
                val destination = getDestinationUseCase()
